...
export default function ApiKeysCard({ elKey, gmKey, orKey, setElKey, setGmKey, setOrKey }) {
  ...
  return (
    <div className="card">
      ...
      <div className="kr">
        <input type="password" value={elKey} placeholder="sk_xxxxxxxxxxxxxxxx" autoComplete="off" onChange={e => saveKey('el', e.target.value)} />
      ...
      <div className="kr">
        <input type="password" value={gmKey} placeholder="AIzaSy..." autoComplete="off" onChange={e => saveKey('gm', e.target.value)} />
      ...
      <div className="kr">
        <input type="password" value={orKey} placeholder="sk-or-v1-..." autoComplete="off" onChange={e => saveKey('or', e.target.value)} />
